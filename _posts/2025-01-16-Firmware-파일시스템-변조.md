...
image:
    path: "/assets/img/posts/firmware_filesystem_modify/image%203.png"
    alt: "TP-Link Firmware"
    lqip: "/assets/img/posts/firmware_filesystem_modify/image%203.png"
---
...
- 2024-01-30 - latest
    ...
    1. 펌웨어 확인
        ...
        ![alt text](/assets/img/posts/firmware_filesystem_modify/image%201.png)
    ...
    2. squashfs 카빙
        ...
        ![image.png](/assets/img/posts/firmware_filesystem_modify/image%202.png)
    ...
    3. unsquashfs
        ...
        ![image.png](/assets/img/posts/firmware_filesystem_modify/image%203.png)
